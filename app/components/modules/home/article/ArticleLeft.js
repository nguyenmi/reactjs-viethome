...
// if (this.props.data !== 0) {
    // <div className="item-one" key={this.props.data.id}>
    //     <div className="article-item" style={{'backgroundImage':`url(${this.props.data.image})`}} >
    //         <a className="txt-link" href="#">
    //             <img className="img-article " src="{this.props.data.image}"/>
    //         </a>
    //         <p className="caption fontW colorW fs15 posBL">
    //             <a className="colorW" href="#">
