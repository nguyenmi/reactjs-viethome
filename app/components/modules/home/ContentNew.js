    ...
    render(){
        return (
            <div className={`content ${this.props.type}`} key = {this.props.data.id}>
                ...
                <p className="text-cate hv-red"><a className="hv-red" href="#">{this.props.data.cateOne}</a></p>
                <h4 className="title-cates fs15"><a className="txt-link" href="#">{this.props.data.titleCateOne}</a></h4>
                </div>
            </div>
        )
    }
