...
// import img from '../../../public/img/footer.png';
        ...
        <div>
            <div className="footer">
                ...
                <div className="right">
                    ...
                    <div className="adver-foot" style={{'backgroundImage':`url(img/quangcao_f1.png)`}}>
                        <a href="#">
                            <img className="img-article" src="img/quangcao_f1.png"/>
                        </a>
                    </div>
                </div>
            </div>
