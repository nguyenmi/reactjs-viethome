            ...
            <div className="menu">
                ...
                <div className="navigation" id="head">
                    <ul className="menu-content">
                        <li className="title-menu"><a className="txt-link" href="/#/news">News</a></li>
                        <li className="title-menu" ><a className="txt-link" href="/#/video">Video</a></li>
                        <li className="title-menu" ><a className="txt-link" href="/#/detailnews">Detail News</a></li>
                        <li className="title-menu" ><a className="txt-link" href="/#/detailvideo">Detail Video</a></li>
                    </ul>
                </div>
            </div>
